		...
		<div class="row-fluid">
			...
			<div class="controls" style="font-weight:bold; text-align:center; color:#D41F00; margin-bottom:10px;">
				...
				<div class="widget-block">
					<div class="widget-head"><div style="float:right; margin:4px;"><a href="add_product" style="text-decoration:none;"><button type="submit" class="btn btn-info">Insert</button></a>
          ...
          <thead>
            ...
            <tr height="50px">
              ...
              <td>Image</td>
              <td>                <a class="asc" href="http://localhost/classic_final1/admin/index.php?route=catalog/product&amp;token=62d711b829152a7eafc8c23f63a0bcad&amp;sort=pd.name&amp;order=DESC">Product Name</a>
                </td>
              <td>                <a href="http://localhost/classic_final1/admin/index.php?route=catalog/product&amp;token=62d711b829152a7eafc8c23f63a0bcad&amp;sort=p.model&amp;order=DESC">Model</a>
                </td>
              <td>                <a href="http://localhost/classic_final1/admin/index.php?route=catalog/product&amp;token=62d711b829152a7eafc8c23f63a0bcad&amp;sort=p.price&amp;order=DESC">Price</a>
                </td>
              <td>                <a href="http://localhost/classic_final1/admin/index.php?route=catalog/product&amp;token=62d711b829152a7eafc8c23f63a0bcad&amp;sort=p.quantity&amp;order=DESC">Quantity</a>
                </td>
              <td>                <a href="http://localhost/classic_final1/admin/index.php?route=catalog/product&amp;token=62d711b829152a7eafc8c23f63a0bcad&amp;sort=p.status&amp;order=DESC">Status</a>
                </td>
              <td>Action</td>
            </tr>
